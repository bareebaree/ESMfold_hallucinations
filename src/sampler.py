        ...
        for i in range(self.n_steps):
            ...
            if self.verbose:
                ...
                for idx,variant in enumerate(x_strs):
                    ...
                    # Save variant and score to CSV log
                    log_path = "mnt/c/Users/james/Masters_Degree/Thesis/protein_language_model_project/results/evoprotgrad_run_log.csv"
                    ...
                    with open(log_path, mode='a', newline='') as file:
                        ...
                        if write_header:
                            writer.writerow(['step', 'chain_idx', 'sequence', 'score'])
                        writer.writerow([i, idx, ''.join(variant.split()), f'{PoE[idx].item():.5f}'])
